...
SUBROUTINE MELT_ZL1994sphere(DIN, TLAYER, PLAYER, RLAYER, VT, SEKDEL, DENSE, DENSA, DOUT)
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!f2py REAL*8, INTENT(IN) :: TLAYER, PLAYER, RLAYER, VT
      ...
      ! Calculate Nusselt (NU_H, for heat) and Sherwood (SH_V, for vapor) numbers
      ! currently, only using for spheres.
      NU_H=2.0+0.357*(0.71)**(0.333333333)*(RE**0.570) 
      SH_V=2.0+0.357*(0.60)**(0.333333333)*(RE**0.570)
      ...
      dmlt = -SEKDEL  / (DCM * ALF) * (NU_H*AK*tclayer + 2.*PI*SH_V*ALV*DI*DELRWC) ! gram
  ...
  END SUBROUTINE MELT_ZL1994sphere
